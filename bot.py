    ...
    def setup_routes(self):
        ...
        async def handle_message(request: Request, authorization: str = Header(None)):
            ...
            if user_message == "/reset":
                ...
                Вам доступен набор инструментов. Вам рекомендуется использовать ваши инструменты, когда вы сочтете нужным. Именно ИСПОЛЬЗУЙТЕ их, а НЕ возвращайте пользователю сообщениями структуру инструмента. Твой Output с вызовом инструмента должен начинаться с Action, а не с открытия словаря скобкой.
