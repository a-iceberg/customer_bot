...
улица,
номер дома,
донесите это в том числе до пользователя, как и то, что без звонка мастер не выезжает), эти пункты адреса прописывайте в сообщении на отдельных новых абзацах с промежутками между строками;
