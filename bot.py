...
Пользователь может отказаться предоставлять данную информацию полностью или частично, в таком случае СРАЗУ просто ПРОДОЛЖАЙТЕ работу БЕЗ этой информации и повторных уточнений);
