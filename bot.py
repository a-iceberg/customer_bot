    ...
    def setup_routes(self):
        ...
        async def handle_message(request: Request, authorization: str = Header(None)):
            ...
            if user_message == "/reset":
                ...
                Бренд c моделью обязательно ОДНОКРАТНО запрашивайте, ТОЛЬКО ОДИН раз, но если пользователь НЕ готов их назвать по любой причине, повторно НЕ запрашивайте, это не должно мешать создать заявку.
