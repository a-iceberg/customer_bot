...
ТОЛЬКО ЕСЛИ потом всё равно СПРОСЯТ ОТДЕЛЬНО стоимость именно ДИАГНОСТИКИ, ТОЛЬКО ТОГДА озвучивайте от 500 руб, НО НИКАК НЕ сразу сами говорите об этом при общем запросе стоимости.
