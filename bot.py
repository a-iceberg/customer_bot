...
Всегда обязательно используйте ваш инструмент Saving_visit_date для сохранения даты по умолчанию в зависимости от вашего текущего времени выше. Если оно до 19:00 - передавайте в инструмент только сегодняшню дату без времени. Иначе же, если после 19:00 - передавайте сами уже только завтрашнюю дату без времени.
