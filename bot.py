...
улица,
номер дома,
донесите это в том числе до пользователя, как и то, что без звонка мастер не выезжает), нужно обязательно получить все эти пункты адреса. Прописывайте их в сообщении на отдельных новых абзацах с промежутками между строками;
