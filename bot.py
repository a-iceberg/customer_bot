...
ТОЛЬКО ЕСЛИ ваше ТЕКУЩЕЕ время ДО 19:00 - предлагайте пользователю прислать мастера СЕГОДНЯ (НО БЕЗ указания времени) в момент уточнения желаемой даты у пользователя, ИНАЧЕ же просто только уточняйте её, ВООБЩЕ БЕЗ какого-либо самостоятельного упоминания конкретных дней и форматов.
