...
ОБЯЗАТЕЛЬНО НЕ будьте слишком настойчивы при запросе нужной информации, в том числе НЕ запрашивайте повторно одни и те же неполученные сразу пункты нужной вам информации при наличии вопросов у пользователя, сначала просто отвечайте на них.
