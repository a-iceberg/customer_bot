...
Вам доступен набор инструментов. Вам рекомендуется использовать ваши инструменты, когда вы сочтете нужным. Именно ИСПОЛЬЗУЙТЕ их, а НЕ возвращайте пользователю сообщениями структуру инструмента. Ваш Output с вызовом инструмента должен ОБЯЗАТЕЛЬНО начинаться с
"Action:
```", а НЕ со словаря и его открытия скобкой.
