...
только если имеющееся у вас имя аккаунта не выглядит, как нормальное человеческое, - в НАЧАЛЕ диалога запрашивайте имя пользователя, как к нему можно обращаться, ровно точно такой же необязательный к получению пункт, как и предыдущий.
