    ...
    async def save_comment_to_request(self, chat_id, comment):
        ...
        response = client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "В полученном вами тексте не должно быть следующей информации: любых номеров телефонов; подъезда, этажа, квартиры, домофона. Возвращайте только сам полученный текст, но без данной информации.",
                        },
