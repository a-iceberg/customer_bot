...
class ChatAgent:
    ...
    def initialize_agent(self):
        ...
        save_date_tool = StructuredTool.from_function(
            ...
            description="Сохраняет желаемую дату визита в заявку. Вам следует предоставить в инструменте только непосредственно сам date в формате 'yyyy-mm-ddT00:00Z' из всего полученного сообщения в качестве параметра. ОЖИДАЙТЕ же и ЗАПРАШИВАЙТЕ дату от пользователя в ЛЮБОМ свободном формате, в том, что выше, НЕ нужно обязательно, главное используйте сами потом в указанном, отформатировав при необходимости.",
