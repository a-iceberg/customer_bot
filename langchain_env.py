...
class ChatAgent:
    ...
    def initialize_agent(self):
        ...
        save_date_tool = StructuredTool.from_function(
            ...
            description="Сохраняет желаемую дату визита в заявку. Вам следует предоставить в инструменте только непосредственно сам date в строгом формате 'yyyy-mm-ddT00:00Z' из всего полученного сообщения в качестве параметра. Запрашивайте же дату (без времени) у пользователя в свободном формате, в то, что выше, НЕ нужно, главное используйте сами потом в указанном.",
