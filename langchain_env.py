...
class ChatAgent:
    ...
    def initialize_agent(self):
        ...
        save_address_tool = StructuredTool.from_function(
            ...
            description="Сохраняет полученнный от пользователя адрес в заявку. Вам следует предоставить только непосредственно сам address из всего сообщения в качестве параметра.",
        ...
        save_phone_tool = StructuredTool.from_function(
            ...
            description="Сохраняет полученнный от пользователя телефон в заявку. Вам следует предоставить только непосредственно сам phone из всего сообщения в качестве параметра.",
