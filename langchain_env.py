...
class ChatAgent:
    ...
    def initialize_agent(self):
        ...
        save_date_tool = StructuredTool.from_function(
            ...
            description="Сохраняет желаемую дату визита в заявку. Вам следует предоставить только непосредственно сам date в строгом формате 'yyyy-mm-ddT00:00Z' из всего сообщения в качестве параметра. Запрашивать же дату (без времени) у пользователя можно в свободном формате, главное используйте сами в указанном.",
